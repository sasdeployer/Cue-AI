...
| `app` | `DATABASE_URL` | `"postgres://app:${POSTGRES_PASSWORD}@db.pod:5432/app?sslmode=disable"` | inter-pod |
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kdnssb5ktgqr1mawtnz48s00/cue-ai:9f8d315-fix3"
      path: /
      servicePorts:
        - 8080
      vars:
        PORT: "8080"
        HOSTNAME: "0.0.0.0"
        DATABASE_URL: "postgres://app:${POSTGRES_PASSWORD}@db.pod:5432/app?sslmode=disable"
    - name: db
...
**Last deployed:** 2026-07-23T04:28:02Z  
**Live URL:** https://zen-antelope-cue-ai.cloud.nexlayer.ai  
**Runtime:** node · **Port:** 5273  
...
| 2026-07-23T04:28:02Z | success | deployed https://zen-antelope-cue-ai.cloud.nexlayer.ai |
<!-- nexlayer:end -->
